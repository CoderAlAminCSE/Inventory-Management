                            ...
                            <div class="controls">
                                <select class="form-control select2" data-placeholder="Choose Supplier" name="supplier_id">
                                    ...
                                    @foreach($supplier as $sp)
                                        <option value="{{ $sp->id }}" <?php if ($sp->id == $editdata->supplier_id) {
                     echo "selected"; } ?> >{{ $sp->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                          </div>
                              ...
                              <div class="controls">
                                <select class="form-control select2" data-placeholder="Choose Category" name="category_id">
                                    ...
                                    @foreach($category as $cat)
                                        <option value="{{ $cat->id }}" <?php if ($cat->id == $editdata->category_id) {
                          ...
                          <div class="form-group">
                              ...
                              <div class="controls">
                                <select class="form-control select2" data-placeholder="Choose Utnit" name="unit_id">
                                    ...
                                    @foreach($unit as $unt)
                                        <option value="{{ $unt->id }}" <?php if ($unt->id == $editdata->unit_id) {
                     echo "selected"; } ?> >{{ $unt->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                          </div>
