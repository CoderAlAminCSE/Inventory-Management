       ...
       <!-- Basic Forms -->
        <div class="box">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <h5>Purchase No<span class="text-danger">*</span></h5>
                                <input type="text" name="purchase_no" id="purchase_no" class="form-control" required>
                          </div>
                      </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="controls">
                                <select class="form-control select2" data-placeholder="Choose Supplier" name="supplier_id" id="supplier_id">
          ...
          <div class="card-body">
            ...
            <br>  
            <div class="form-group">  
              <input type="submit" class="btn btn-rounded btn-info" value="Purchase Store">
            </div>
            </form>
          </div>
...
{{--  select category_id by selecting supplier_id  --}}
<script type="text/javascript">
    $(function(){
